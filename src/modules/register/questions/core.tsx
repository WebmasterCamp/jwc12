...
export const coreWeakQuestions: WeakQuestion = {
  ...
  inputs: [
    ...
    },
    {
      ...
      title: (
        <p className="px-2">
          น้อง ๆ กำลังเดินเข้าสู่ซุ้มหน้าตาประหลาดที่ตั้งอยู่กลางพื้นที่โล่งแจ้ง
          ซึ่งห่างไกลเมืองที่ชาวบ้านอาศัยอยู่อย่างมาก น้อง ๆ จึงจำเป็นที่จะต้องเข้าไปยังซุ้มนี้ และ
          เมื่อน้อง ๆ เข้าไปยังซุ้มหน้าตาประหลาดนี้แล้ว ก็ค้นพบกับโต๊ะตัวหนึ่งที่มีปริศนาต่าง ๆ
          รอให้น้อง ๆ ไขคำตอบอยู่ ดังนี้
        </p>
      ),
    },
    {
      ...
      question: (
        <QuestionWithNumber number={1}>
          <p>
            จำนวนไพ่ทาโรต์ใน 1 สำรับนั้นมี 78 ใบ หากน้อง ๆ ค้นพบว่าน้อง ๆ
            มีพลังวิเศษที่สามารถสร้างไพ่ใบที่ 79 ได้น้อง ๆ จะสร้างไพ่ใบที่ 79
            ให้มีความสามารถพิเศษที่จะเปลี่ยนแปลงโชคชะตาอนาคตให้กับผู้ที่ได้ไพ่ใบนี้ในเรื่องไหน
            อย่างไร และจะต้องตั้งชื่อไพ่ใบนั้น พร้อมสโลแกนของไพ่
            ที่จะทำให้ไพ่ใบนี้ของน้องกลายเป็นไพ่ที่เลิศ สุดยอด วิเศษ มหัศจรรย์ มีพลังอันดับ 1 สูงสุด
            ยอดเยี่ยม ยิ่งใหญ่ เกรียงไกรที่สุดในสำรับ
          </p>
        </QuestionWithNumber>
      ),
